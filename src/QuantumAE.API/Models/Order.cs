...
/// </param>
[PublicAPI]
public sealed record TOrderOpenResponse(string RequestId, int ResultCode, string OrderId) : IResponse;
...
/// </param>
[PublicAPI]
public sealed record TGetIdsResponse(string RequestId, int ResultCode, int Count, IReadOnlyList<string> OrderIds)
  : IResponse;
