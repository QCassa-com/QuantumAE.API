...
/// <summary>
///   hu: ForceOfflineSyncRequest és ForceOfflineSyncResponse szerializációs tesztek (JSON + MessagePack)
///   <br />
///   en: ForceOfflineSyncRequest and ForceOfflineSyncResponse serialization tests (JSON + MessagePack)
/// </summary>
public class TForceOfflineSyncSerializationTests
{
  ...
  #region ForceOfflineSyncRequest - JSON..
  ...
  {
    var original = new ForceOfflineSyncRequest("req-001");

    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<ForceOfflineSyncRequest>(json, CJsonOptions);
  ...
  {
    var request = new ForceOfflineSyncRequest("req-002");
  ...
  #region ForceOfflineSyncRequest - MessagePack..
  ...
  {
    var original = new ForceOfflineSyncRequest("req-003");

    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<ForceOfflineSyncRequest>(bytes, CMsgpackOptions);
  ...
  #region ForceOfflineSyncResponse - JSON..
  ...
  {
    var original = new ForceOfflineSyncResponse(
      RequestId: "req-004",
      ResultCode: 0
    );

    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<ForceOfflineSyncResponse>(json, CJsonOptions);
  ...
  {
    var response = new ForceOfflineSyncResponse(
      RequestId: "req-006",
      ResultCode: 0
    );
  ...
  #region ForceOfflineSyncResponse - MessagePack..
  ...
  public void Response_MessagePack_RoundTrip_Success()
  {
    ...
    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<ForceOfflineSyncResponse>(bytes, CMsgpackOptions);
  ...
  {
    var request = new ForceOfflineSyncRequest("req-009");
  ...
  {
    var response = new ForceOfflineSyncResponse("req-010", 0);
