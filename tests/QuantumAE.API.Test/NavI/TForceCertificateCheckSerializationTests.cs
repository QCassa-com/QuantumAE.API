...
/// <summary>
///   hu: ForceCertificateCheckRequest és ForceCertificateCheckResponse szerializációs tesztek (JSON + MessagePack)
///   <br />
///   en: ForceCertificateCheckRequest and ForceCertificateCheckResponse serialization tests (JSON + MessagePack)
/// </summary>
public class TForceCertificateCheckSerializationTests
{
  ...
  #region ForceCertificateCheckRequest - JSON..
  ...
  {
    var original = new ForceCertificateCheckRequest("req-001");

    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<ForceCertificateCheckRequest>(json, CJsonOptions);
  ...
  {
    var request = new ForceCertificateCheckRequest("req-002");
  ...
  #region ForceCertificateCheckRequest - MessagePack..
  ...
  {
    var original = new ForceCertificateCheckRequest("req-003");

    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<ForceCertificateCheckRequest>(bytes, CMsgpackOptions);
  ...
  #region ForceCertificateCheckResponse - JSON..
  ...
  {
    var original = new ForceCertificateCheckResponse(
      RequestId: "req-004",
      ResultCode: 0
    );

    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<ForceCertificateCheckResponse>(json, CJsonOptions);
  ...
  {
    var response = new ForceCertificateCheckResponse(
      RequestId: "req-006",
      ResultCode: 0
    );
  ...
  #region ForceCertificateCheckResponse - MessagePack..
  ...
  public void Response_MessagePack_RoundTrip_Success()
  {
    ...
    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<ForceCertificateCheckResponse>(bytes, CMsgpackOptions);
  ...
  {
    var request = new ForceCertificateCheckRequest("req-009");
  ...
  {
    var response = new ForceCertificateCheckResponse("req-010", 0);
