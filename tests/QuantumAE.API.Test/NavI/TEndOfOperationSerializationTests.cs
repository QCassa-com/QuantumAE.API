...
/// <summary>
///   hu: EndOfOperationRequest és EndOfOperationResponse szerializációs tesztek (JSON + MessagePack)
///   <br />
///   en: EndOfOperationRequest and EndOfOperationResponse serialization tests (JSON + MessagePack)
/// </summary>
public class TEndOfOperationSerializationTests
{
  ...
  #region EndOfOperationRequest - JSON..
  ...
  {
    var original = new EndOfOperationRequest("req-001");

    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<EndOfOperationRequest>(json, CJsonOptions);
  ...
  {
    var request = new EndOfOperationRequest("req-002");
  ...
  #region EndOfOperationRequest - MessagePack..
  ...
  {
    var original = new EndOfOperationRequest("req-003");

    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<EndOfOperationRequest>(bytes, CMsgpackOptions);
  ...
  #region EndOfOperationResponse - JSON..
  ...
  {
    var original = new EndOfOperationResponse(
      RequestId: "req-004",
      ResultCode: 0
    );

    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<EndOfOperationResponse>(json, CJsonOptions);
  ...
  {
    var response = new EndOfOperationResponse(
      RequestId: "req-006",
      ResultCode: 0
    );
  ...
  #region EndOfOperationResponse - MessagePack..
  ...
  public void Response_MessagePack_RoundTrip_Success()
  {
    ...
    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<EndOfOperationResponse>(bytes, CMsgpackOptions);
  ...
  {
    var request = new EndOfOperationRequest("req-009");
  ...
  {
    var response = new EndOfOperationResponse("req-010", 0);
