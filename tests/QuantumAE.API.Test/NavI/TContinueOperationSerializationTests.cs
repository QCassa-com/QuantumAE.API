...
/// <summary>
///   hu: ContinueOperationRequest és ContinueOperationResponse szerializációs tesztek (JSON + MessagePack)
///   <br />
///   en: ContinueOperationRequest and ContinueOperationResponse serialization tests (JSON + MessagePack)
/// </summary>
public class TContinueOperationSerializationTests
{
  ...
  #region ContinueOperationRequest - JSON..
  ...
  {
    var original = new ContinueOperationRequest("req-001");

    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<ContinueOperationRequest>(json, CJsonOptions);
  ...
  {
    var request = new ContinueOperationRequest("req-002");
  ...
  #region ContinueOperationRequest - MessagePack..
  ...
  {
    var original = new ContinueOperationRequest("req-003");

    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<ContinueOperationRequest>(bytes, CMsgpackOptions);
  ...
  #region ContinueOperationResponse - JSON..
  ...
  {
    var original = new ContinueOperationResponse(
      RequestId: "req-004",
      ResultCode: 0,
    ...
    var json = JsonSerializer.Serialize(original, CJsonOptions);
    var deserialized = JsonSerializer.Deserialize<ContinueOperationResponse>(json, CJsonOptions);
  ...
  {
    var response = new ContinueOperationResponse(
      RequestId: "req-006",
      ResultCode: 0
    );
  ...
  #region ContinueOperationResponse - MessagePack..
  ...
  public void Response_MessagePack_RoundTrip_Success()
  {
    ...
    var bytes = MessagePackSerializer.Serialize(original, CMsgpackOptions);
    var deserialized = MessagePackSerializer.Deserialize<ContinueOperationResponse>(bytes, CMsgpackOptions);
  ...
  {
    var request = new ContinueOperationRequest("req-009");
  ...
  {
    var response = new ContinueOperationResponse("req-010", 0);
